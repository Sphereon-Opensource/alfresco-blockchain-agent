...
public class BlockchainProofApiConfig {
    ...
    public BlockchainProofApiConfig(@Value("${sphereon.blockchain.agent.blockchain-proof.application-name") final String applicationName,
                                    @Value("${sphereon.blockchain.agent.blockchain-proof.base-path:https://gw.api.cloud.sphereon.com/blockchain/proof/0.10}") final String bcProofBasePath,
                                    @Value("${sphereon.blockchain.agent.blockchain-proof.api-client.timeout:120000}") final int connectionTimeout) {
